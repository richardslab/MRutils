...
# make sure that numeric field are truly numeric

# make sure that POS is positive

# make sure that CHR is truly in the reference

# make sure that the alleles are indeed from [ACGT]

# is the P really genome-wide significant

# confirm that rsids are indeed of the format "rs[0-9]*"
```



```{r debug3, verbose=TRUE}
data = data %>% mutate(POS = BP, CHR = gsub("^chr", "", CHR), BP = NULL)
```

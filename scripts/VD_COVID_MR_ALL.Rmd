...
print(glue("...and {nrow(exposure_and_proxies)} proxies were succesfully merged with the exposure."))
...
ggplot(ld_pairs) +  
  ...
  aes(fill = value > params$prune_r2_threshold, alpha= ifelse(RS_number %in% removed_rsids | variable %in% removed_rsids, 0.1,1)) + 
